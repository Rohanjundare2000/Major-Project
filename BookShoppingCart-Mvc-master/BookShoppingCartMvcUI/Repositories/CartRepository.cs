        ...
        */
        ...
        public async Task<bool> DoCheckout(CheckoutModel model)
        {
            ...
            try
            {
                ...
                _db.Orders.Add(order);
                await _db.SaveChangesAsync(); // Save changes to get the order ID
                ...
                _db.CartDetails.RemoveRange(cartDetail);
                await _db.SaveChangesAsync(); // Save changes after removing cart details
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"Error in DoCheckout: {ex.Message}");
